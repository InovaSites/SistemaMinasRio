		...
		<div class="modal-content">
			...
			<form id="form_itens">
				...
				<div class="resumo-tabela">
					...
					<div class="resumo-linha adicionais">
						<div class="adicionais-group"> <label for="adicional_valor">Adicional</label> <input type="text" placeholder="Adicional" id="adicional_valor" name="adicional" onkeyup="calcularValorDA()"> <input type="text" placeholder="Descrição" name="descricao_a" id="descricao_a"> </div>
						<div class="adicionais-group"> <label for="desconto_valor">Desconto</label> <input type="text" placeholder="Desconto" id="desconto_valor" name="desconto" onkeyup="calcularValorDA()"> <input type="text" placeholder="Descrição" name="descricao_d" id="descricao_d"> </div>
					</div>
